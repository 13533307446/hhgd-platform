var NewApiRootUrl = 'https://h.kumanju.com/api/';
...
module.exports = {
    ...
    AuthLoginByWeixinV2: NewApiRootUrl + 'auth/login_by_weixin_v2', //微信登录(新的方式，按下按钮，然后wx.login)
    ...
    OrderQuerylist: NewApiRootUrl + 'orderProcess/querylist',  //查看订单详情
