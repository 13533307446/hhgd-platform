$(function () {
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '跟单人', name: 'handler', index: 'handler', width: 80 },
            {
    ...
    methods: {
        ...
        updateprogress:function(even){
             ...
             openWindow({
                 type: 2,
                 title: '进度信息',
                 content: '../shop/orderprocess.html?orderId=' + id
             })
         },
         downloadOrder:function(even){
 			...
 			window.location.href='../order/downloadOrder?ids=' + idsStr.substr(1);
            
         },
          saveProgress:function(even){
        	  $.ajax({
                  type: "POST",
                  url: '../order/updateprogress',
                  contentType: "application/json",
        ...
        lookDetail: function (rowId) { //第三步：定义编辑操作
            ...
            $.get("../ordergoods/queryAll/?orderId=" + rowId, function (r) {
                vm.goodsInfoContent=[];
                vm.goodsInfoContent=r.list;
            });
        },
