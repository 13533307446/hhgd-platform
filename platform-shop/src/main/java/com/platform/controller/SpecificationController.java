...
public class SpecificationController {
	 ...
	 * 根据商品ID查询规格
	 */
	@RequestMapping("/queryByGoodId")
	public R queryByGoodId(@PathVariable("goodId") Integer goodId) {
		List<SpecificationEntity> list = specificationService.queryByGoodsId(goodId);
		return R.ok().put("list", list);
	}
}
